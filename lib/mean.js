...
function findModules(callback) {
  ...
  Q.all([searchSource('node_modules'), searchSource('server/core'),searchSource('packages/terminal'),searchSource('packages/manager'),searchSource('packages/website')]).done(function() {
